...
async def get_thumb(videoid):
    ...
    try:
        ...
        font_size = 40
        font = ImageFont.truetype("BADMUSIC/assets/font2.ttf", font_size)
        font2_size = 70
        font2 = ImageFont.truetype("BADMUSIC/assets/font2.ttf", font2_size)
        arial = ImageFont.truetype("BADMUSIC/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("BADMUSIC/assets/font.ttf", 40)
        
        para = textwrap.wrap(clear(title), width=32) 
        j = 0
        draw.text(
            (6, 6), f"DJ PUNJAB", fill="black", font=name_font
        )
        draw.text(
            (600, 200),
            f"BROKEN ♡︎ MUSIC",
